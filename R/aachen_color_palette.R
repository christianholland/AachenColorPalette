...
#' \code{\link[=display_aachen_colors]{display_aachen_colors()}} for color names) and color
#' intensity. For colors with 100\% intensity the color name alone is sufficient.
#'
#'
